...
{
	memset( &TransformMemData, 0, sizeof( tstTransformData ) );
...
*/
void Transform::SetMatrixMode( unsigned int mode )
{
...
/*!
 ...
 \return Return a 4x4 matrix pointer of the top most modelview matrix.
 */
glm::mat4* Transform::GetViewMatrix( void )
{
...
*/
glm::mat4* Transform::GetProjectionMatrix( void )
{
...
*/
glm::mat4* Transform::GetTextureMatrix( void )
{
 ...
 */
glm::mat4* Transform::GetModelViewProjectionMatrix( void )
{
...
*/
glm::mat4* Transform::GetModelViewMatrix( void )
{
...
/*!
 ...
 \return None.
 */
void Transform::PushMatrix( void )
{
	switch( TransformMemData.matrix_mode )
	{
        case MODEL_MATRIX:
 ...
 */
void Transform::LoadMatrix( glm::mat4 *m )
{
	switch( TransformMemData.matrix_mode )
	{
		case MODEL_MATRIX:
 ...
 */
void Transform::MultiplyMatrix( glm::mat4 *m )
{
	switch( TransformMemData.matrix_mode )
	{
		case MODEL_MATRIX:
	...
	{            
		...
		case VIEW_MATRIX:
		{
			*GetViewMatrix() = glm::translate( *GetViewMatrix(), v);
            glm::mat4* m_viewMatrix = GetViewMatrix();            
			break;
		}
...
*/
void Transform::GetNormalMatrix( glm::mat3* mat3Obj )
{
	glm::mat4 mat4Obj;
...
*/
void Transform::Ortho( float left, float right, float bottom, float top, float clip_start, float clip_end )
{
	switch( TransformMemData.matrix_mode )
	{
		case MODEL_MATRIX:
...
*/
void Transform::OrthoGrahpic( float screen_ratio, float scale, float aspect_ratio, float clip_start, float clip_end, float orientation )
{
...
*/
void Transform::SetPerspective( float fovy, float aspect_ratio, float clip_start, float clip_end)
{
	switch( TransformMemData.matrix_mode )
	{            
		case MODEL_MATRIX:
...
void Transform::SetView(glm::mat4 mat)
{
...
*/
int Transform::Project( float objextx, float objecty, float objectz, glm::mat4 *modelview_matrix, glm::mat4 *projection_matrix, int *viewport_matrix, float *windowx, float *windowy, float *windowz )
{
	glm::vec4 vin,
		 vout;
...
*/
int Transform::Unproject( float windowx, float windowy, float windowz, glm::mat4 *modelview_matrix, glm::mat4 *projection_matrix, int *viewport_matrix, float *objextx, float *objecty, float *objectz )
{
	glm::mat4 final;

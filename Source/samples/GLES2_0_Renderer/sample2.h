...
#define VERTEX_SHADER_PRG2        (char * )"../Source\\samples\\GLES2_0_Renderer\\shader\\RectangleVertex.glsl"
#define FRAGMENT_SHADER_PRG2      (char * )"../Source\\samples\\GLES2_0_Renderer\\shader\\RectangleFragment.glsl"

void SamplePerespective(){
   float width  = 1.0f;
   float height = 1.0f;
   glm::vec3 tempVtx[4] = {
   ...
   for(float i = 0; i<COLS; i++)
   {
      ...
      {
         rectangleItem = new HMIRectangle(scene, NULL, BUTTON,"");

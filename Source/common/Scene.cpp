...
Scene::Scene(std::string name, ObjectRelative* parentObj):ObjectRelative(name, parentObj)
{
    renderManager   = NULL;
    currentCamera   = NULL;
    currentModel    = NULL;
...
void Scene::Resize(int w, int h)
{
	...
	// Need to set the camera resize here currently not implemented
 ...
 //           continue;
 //       }
	//	currentCamera->Viewport(0.0, 0.0, w, h);
	//}	
}
...
/*!
	...
	\return void.
 */
void Scene::Render(bool (*customRender)())
{
    for(int j=0; j<cameras.size(); j++){

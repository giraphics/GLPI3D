#ifndef WAVEFRONTOBJNEW_H
#define WAVEFRONTOBJNEW_H
#include <vector>
#include "GLutils.h"
#include "Material.h"
...
public:
    ...
    Mesh* ParseObjModel(const char* path, bool flatShading = false);
...
private:
    ...
    bool ParseFileInfo(const char* path);
	...
	//! Parse the material information from the face
	bool ScanMaterial(FILE* pFile, char c);

	//! Parse the material file information from the face
	bool ScanMaterialFile(FILE* pFile, const char* path);
